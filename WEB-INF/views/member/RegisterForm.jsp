              ...
              <div class="col-sm-5 col-sm-offset-1 mb-sm-40" style="float: none; margin:0 auto;">
                ...
                <form class="form" action="/member/Register" method="post">
                  <div class="form-group">
                    <input class="form-control input-lg well" id="MEM_ID" name="MEM_ID" type="text"   placeholder="ID" style="width: 360px; float: left ;text-transform: lowercase;"/>
                  ...
                  <div class="form-group">
                    <input class="form-control input-lg well" id="MEM_PW" type="text" name="MEM_PW"  placeholder="PASSWORD" style="text-transform: lowercase;"/>
                  </div>  
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input class="form-control input-lg well" id="MEM_EMAIL" type="email" name="MEM_EMAIL"  placeholder="EMAIL" style="width: 360px; float: left ;text-transform: lowercase"/>
