              ...
              <div class="col-sm-5 col-sm-offset-1 mb-sm-40" style="float: none; margin:0 auto;">
                ...
                <form class="form" action="/member/findPw" method="post">
                  <div class="form-group">
                    <input class="form-control input-lg well" id="MEM_ID" type="text" name="MEM_ID" placeholder="ID" style="text-transform: lowercase;"/>
                  </div>
                  <div class="form-group">
                    <input class="form-control input-lg well" id="MEM_EMAIL" type="email" name="MEM_EMAIL" placeholder="EMAIL" required="required" style="text-transform: lowercase;">
                  </div>
                  <div class="form-group">
